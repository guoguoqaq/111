...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='checkpoints_ae/VGAE_GuideVane_2.5D_best.pt')
    ...
    # def slice_loc_features(graph):
    #     if hasattr(graph, 'loc'):
    #         graph.loc = graph.loc[:, :9]  # 只保留前9个特征
    #     return graph
    ...
    arch = {
        ...
        'latent_node_features': 4, 'depths': [2, 2, 2], 'fnns_depth': 2, 'fnns_width': 128,
