"""
    Train a Flow-matching Graph Net (FMGN) to predict the pressure field on an ellipse.
    Run with:
        python train_fmgn.py --experiment_id 0 --gpu 0
"""
...
model = dgn.nn.FlowMatchingGraphNet(arch = arch)
