"""
    Train a Latent Diffusion Graph Net (LDGN) to predict the pressure field on an ellipse.
    Run with:
...
arch = {
    ...
    'cond_node_features': 128, # Latent features for Re, d_bottom and d_top
    'cond_edge_features': 128, # Latent edge features
